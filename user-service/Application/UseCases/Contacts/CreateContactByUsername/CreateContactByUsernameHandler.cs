...
public class CreateContactByUsernameHandler
    :IRequestHandler<CreateContactByUsernameCommand,Result<ReadContactDto>>
{
    ...
    public async Task<Result<ReadContactDto>> Handle(CreateContactByUsernameCommand request,
        CancellationToken cancellationToken)
    {
        var userContact = await _userContactRepository.GetUserContactByUsernameAsync(
            request.UserId, request.ContactUsername, cancellationToken);
